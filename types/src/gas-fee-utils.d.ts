 ...
 * @type {number}
 */
export declare const DEFAULT_TRANSFER_GAS_LIMIT: number;
/**
 ...
 */
export declare const DEFAULT_GAS_PRICE_STEP: {
    low: number;
    average: number;
    high: number;
};
 ...
 */
export declare function calculateFeeAmountFromGasPrice(gasPriceAmount: number, gasLimit?: number): bigint | undefined;
/**
 ...
 */
export declare function extractGasPrice(gasPrice: string | undefined): {
